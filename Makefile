# Makefile for Copper Kingdom Plugin Server Management
...
help: ## Show this help message
	@echo "⚒️ Copper Kingdom Plugin - Development Commands"
	@echo ""
...
test-commands: build install ## Build, install and show test commands
	...
	@echo "  /copperkingdom give copper_sword    - Give yourself a copper sword"
	@echo "  /copperkingdom give copper_axe      - Give yourself a copper axe"
	@echo "  /copperkingdom give copper_pickaxe  - Give yourself a copper pickaxe"
	@echo "  /copperkingdom help                 - Show command help"
	@echo ""
	@echo "=== Admin Commands (op required) ==="
	@echo "  /copperkingdom reload               - Reload plugin configuration"
	@echo ""
	@echo "=== Crafting Test ==="
	@echo "  Craft copper weapons using copper ingots and sticks"
	@echo "  Check for enchantment rolls (poison, high durability, bonus damage)"
	@echo ""
...
release: validate build ## Create a release build
	...
	@mkdir -p releases
	@cp target/copper-kingdom-*.jar releases/
	@echo "✅ Release created in releases/ directory"

# Give copper materials for testing
give-copper: ## Give copper materials to test crafting
	@echo "Creating copper materials command..."
	@echo "Run these in game:"
	@echo "/give @p minecraft:copper_ingot 64"
	@echo "/give @p minecraft:stick 64"
	@echo "Then try crafting copper weapons!"
